            ...
            ViewFrame({
              children: [
                Header({
                  ...
                  links: derived(() => {
                    const routerHash = router.hash;
                    console.log(`new hash value is: ${routerHash.value}`);
                    return [
                      {
                        isSelected: routerHash.value === "#products",
                        href: "#products",
                        label: "Products",
                      },
                      {
                        isSelected: routerHash.value === "#blogs",
                        href: "#blogs",
                        label: "Blogs",
                      },
                      {
                        isSelected: routerHash.value === "#about-us",
                        href: "#about-us",
                        label: "About Us",
                      },
                    ];
